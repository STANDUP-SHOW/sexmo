    ...
    <div className="space-y-10">
      ...
      <section className="text-center py-10 space-y-4">
        ...
        <p className="text-neutral-500 max-w-2xl mx-auto">
          Rencontre gratuite, annonces entre particuliers, rendez-vous libertin et rencontre éphémère ou coquine :
          sexmo réunit à {city.name} des célibataires et couples ouverts d'esprit, adultes consentants, pour discuter,
          draguer en ligne et se rencontrer en toute discrétion. Inscription gratuite en 45 secondes, sans carte
          bancaire, sans publicité.
        </p>
        {count != null && count > 0 && (
