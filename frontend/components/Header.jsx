...
export default function Header() {
  ...
  return (
    <header className="border-b border-neutral-800 sticky top-0 bg-black/95 backdrop-blur z-20">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        {user ? (
          <nav className="flex items-center gap-4 text-sm text-neutral-200">
            ...
            <button onClick={logout} className="bg-neutral-800 hover:bg-neutral-700 text-white text-xs font-medium px-3 py-1.5 rounded-lg transition">
              Déconnexion
            </button>
          </nav>
        ) : (
