// Pratiques libertines proposées à la case à cocher sur le profil, regroupées
// par thème. Liste fermée et modérable (contrairement à "interests" en texte
// libre) : les clés servent aussi bien à l'affichage qu'à la validation côté
// serveur du PATCH /api/profiles/me.
...
const ALL_PRACTICE_KEYS = PRACTICE_CATEGORIES.flatMap((c) => c.practices.map((p) => p.key));

module.exports = { PRACTICE_CATEGORIES, ALL_PRACTICE_KEYS };
